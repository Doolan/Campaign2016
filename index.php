		...
		<nav>
			...
			<ul id="menu">
				...
				<li>
					...
					<ul class="hidden">
						<li>
							<a href="news.html#Exclusive">Exclusive</a>
						</li>
						<li>
	...
	<div  id="breaking" style="display:none;">
		...
		<div class="layer2">
			<div class="titleText">
				...
				<h2 id="changesToTeam">
					Morgan Escalera steps down as a Presidential Candidate
					<br>Emily Bochnowski named as replacement</h2>
			</div>
		</div>
	</div>
	<div class="mainText" id="breakingP">
		<p>
			"I, Morgan Escalara, have chosen to step down as a presidential candidate. My only daughter was injured by a drunk driver and has hospitalized at Massachusetts General Hospital in the Medical Intensive Care Unit. The doctors have placed her in a medically induced coma..." (
			<a href="speeches.html#Accident" title="Read More">Continue Reading</a>
			)
			<br>-Senator Escalara</p>
		<p>
			"I could not image worse circumstances, and it is with great sorrow that I accept the responsibility of replacing Senator Escalera as a Presidential Candidate. I believe my core beliefs overlap extensively with Senator Escalera. I will fight to promote our shared vision of the future.  I hope that the supporters of the Escalera and Doolan campaign will not lose hope in this ticket, but rather will stand behind the new ticket of Bochnowski and Doolan..." (
			<a href="speeches.html#BochnowskiAnnouncement" title="Read More">Continue Reading</a>
			)
			<br>-Senator Bochnowski</p>
		<p onclick="hideclickAll()" style="text-decoration: underline; cursor:pointer;">Continue to the main page</p>
	</div>
</div>

<!--JOIN US BOX-->
<div style="display:none;" id="register" >
	<div id="xbutton" onclick="hideclickAll()">
		<img src="images/x.gif" alt="X"></div>
	<h1>Join Us</h1>
